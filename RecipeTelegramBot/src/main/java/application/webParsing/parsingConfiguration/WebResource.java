...
public class WebResource {
	...
	private Map<String, String> itemsAndURLs;

	public WebResource() {
		itemPage = new ItemPage();
		itemsAndURLs = new HashMap<>();
	}
	...
	public Map<String, String> getItemsAndURLs() {
		return itemsAndURLs;
	}

	public void setItemsAndURLs(Map<String, String> itemsAndURLs) {
		this.itemsAndURLs = itemsAndURLs;
	}
